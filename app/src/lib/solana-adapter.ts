...
export class TransactionUtils {
  ...
  static getExplorerUrl(signature: string, cluster: 'devnet' | 'testnet' | 'mainnet-beta' = 'devnet'): string {
    const baseUrl = cluster === 'mainnet-beta' ? 'https://solscan.io' : `https://solscan.io/${cluster}`;
    return `${baseUrl}/tx/${signature}`;
  }

  static getTokenExplorerUrl(address: string, cluster: 'devnet' | 'testnet' | 'mainnet-beta' = 'devnet'): string {
    const baseUrl = cluster === 'mainnet-beta' ? 'https://solscan.io' : `https://solscan.io/${cluster}`;
